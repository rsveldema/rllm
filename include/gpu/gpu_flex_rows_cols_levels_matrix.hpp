...
namespace rllm
{
    ...
    class gpu_flex_rows_cols_levels_matrix : public offloadable_data<ElementType>
    {
      public:
        ...
        void copy_from_cpu(const cpu_flex_rows_cols_levels_matrix<ElementType, L, X, Y>& src)
        {
        ...
        void copy_to_cpu(cpu_flex_rows_cols_levels_matrix<ElementType, L, X, Y>& dst) const
        {
