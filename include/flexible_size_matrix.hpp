...
namespace rllm
{
    ...
    class flexible_size_matrix : public offloadable_data<ElementType>
    {
      public:
        ...
        flexible_size_matrix(const flexible_size_matrix& other)
            : offloadable_data<ElementType>(other.m_capacity_elements)
            , m_rows(other.m_rows)
            , m_cols(other.m_cols)
        ...
        flexible_size_matrix& operator=(const flexible_size_matrix& other)
        {
            if (this != &other)
            {
        ...
        flexible_size_matrix(flexible_size_matrix&& other)
            : offloadable_data<ElementType>(other.m_capacity_elements)
            , m_rows(other.m_rows)
            , m_cols(other.m_cols)
            , m_capacity_elements(other.m_capacity_elements)
        ...
        flexible_size_matrix& operator=(flexible_size_matrix&& other)
        {
            if (this != &other)
            {
                ensure_capacity(other.m_capacity_elements);
        ...
        inline void set(X x, Y y, ElementType value)
        {
            (*this)[x, y] = value;
        }
        ...
        inline const ElementType& get(X x, Y y) const
        {
            return (*this)[x, y];
        }
        ...
        inline ElementType& operator[](X x, Y y)
        {
            ...
            return this->m_data.get()[flat_index(x, y)];
        }
