...
namespace rllm
{
    ...
    void adamw_update(fixed_size_matrix<float16, EmbeddingDimension, EmbeddingDimension>& weight, fixed_size_matrix<float, EmbeddingDimension, EmbeddingDimension>& first, fixed_size_matrix<float, EmbeddingDimension, EmbeddingDimension>& second, const fixed_size_matrix<float, EmbeddingDimension, EmbeddingDimension>& gradient, float learning_rate, float bias_correction1, float bias_correction2, fixed_size_vector<float, TempStorage>& diagnostics, int collect_diagnostics);
    void adamw_update(fixed_size_matrix<float16, FFDimension, EmbeddingDimension>& weight, fixed_size_matrix<float, FFDimension, EmbeddingDimension>& first, fixed_size_matrix<float, FFDimension, EmbeddingDimension>& second, const fixed_size_matrix<float, FFDimension, EmbeddingDimension>& gradient, float learning_rate, float bias_correction1, float bias_correction2, fixed_size_vector<float, TempStorage>& diagnostics, int collect_diagnostics);
    void adamw_update(fixed_size_matrix<float16, EmbeddingDimension, FFDimension>& weight, fixed_size_matrix<float, EmbeddingDimension, FFDimension>& first, fixed_size_matrix<float, EmbeddingDimension, FFDimension>& second, const fixed_size_matrix<float, EmbeddingDimension, FFDimension>& gradient, float learning_rate, float bias_correction1, float bias_correction2, fixed_size_vector<float, TempStorage>& diagnostics, int collect_diagnostics);
    void adamw_update_embeddings(fixed_size_matrix<float16, TokenID, EmbeddingDimension>& weight, fixed_size_matrix<float, TokenID, EmbeddingDimension>& first, fixed_size_matrix<float, TokenID, EmbeddingDimension>& second, const fixed_size_matrix<float, TokenID, EmbeddingDimension>& gradient, const fixed_size_vector<int, TokenID>& touched, float learning_rate, float bias_correction1, float bias_correction2, fixed_size_vector<float, TempStorage>& diagnostics, int collect_diagnostics);
    void adamw_update_identifier_embeddings(fixed_size_matrix<float16, IdentifierHashBucket, EmbeddingDimension>& weight, fixed_size_matrix<float, IdentifierHashBucket, EmbeddingDimension>& first, fixed_size_matrix<float, IdentifierHashBucket, EmbeddingDimension>& second, const fixed_size_matrix<float, IdentifierHashBucket, EmbeddingDimension>& gradient, const fixed_size_vector<int, IdentifierHashBucket>& touched, float learning_rate, float bias_correction1, float bias_correction2, fixed_size_vector<float, TempStorage>& diagnostics, int collect_diagnostics);
